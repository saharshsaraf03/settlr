    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          <SettlrLogo />
          <div className="mt-8 rounded-xl border border-slate-800 bg-slate-900/80 p-8">
            ...
            <button
              ...
              className="mt-6 text-sm text-[#00D4AA] hover:text-[#00BF99]"
            >
              Back to sign in
            </button>
          </div>
        ...
        <Card className="border-slate-800 bg-slate-900/80 shadow-xl">
          <CardContent className="p-8">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-400 mt-1">Start splitting bills effortlessly</p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-slate-400">
              ...
              <Link to="/login" className="text-[#00D4AA] hover:text-[#00BF99] font-medium">
                Sign in
              </Link>
            </p>
          </CardContent>
